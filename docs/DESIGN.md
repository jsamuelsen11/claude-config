...
| --- | ------------------- | ------ | -------- | ------ | ----- | -------------- |
| 1   | ccfg-core           | 19     | 6        | 3      | 4     | github-mcp     |
| 2   | ccfg-python         | 7      | 3        | 3      | -     | -              |
| 3   | ccfg-golang         | 5      | 3        | 3      | -     | -              |
| 4   | ccfg-typescript     | 9      | 3        | 4      | -     | playwright-mcp |
| 5   | ccfg-java           | 5      | 3        | 3      | -     | -              |
| 6   | ccfg-rust           | 4      | 3        | 3      | -     | -              |
| 7   | ccfg-csharp         | 5      | 3        | 3      | -     | -              |
| 8   | ccfg-shell          | 2      | 2        | 2      | -     | -              |
...
| D4  | **Bootstrap script family for settings.json + CLAUDE.md** | Plugins can't set `permissions.allow`, `alwaysThinkingEnabled`, `enabledPlugins`, or CLAUDE.md. A family of 3 scripts handles these: `ccfg-bootstrap.sh` (global setup), `ccfg-project-init.sh` (per-project), `ccfg-plugins.sh` (third-party). See [BOOTSTRAP.md](./BOOTSTRAP.md). |
